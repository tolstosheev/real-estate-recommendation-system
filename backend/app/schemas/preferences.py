...
class UserPreferenceBase(BaseModel):
    ...
    tags: Optional[List[str]] = Field(None, json_schema_extra={"example": ["modern", "center"]})
    priority_weight: Optional[dict] = Field(None, json_schema_extra={"example": {"price": 0.5, "area": 0.3, "rooms": 0.2}})
