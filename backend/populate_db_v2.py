...
# Реалистичные адреса для Москвы и Тульской области
MOSCOW_ADDRESSES = [
    # ЦАО
    ("Москва", "ул. Тверская", 10, "Apartment", (55.76, 37.61)),
    ("Москва", "ул. Новый Арбат", 20, "Apartment", (55.75, 37.59)),
    ("Москва", "ул. Садовая-Кудринская", 15, "Apartment", (55.77, 37.58)),
    ("Москва", "Патриаршие пруды", 5, "Apartment", (55.76, 37.60)),
    ("Москва", "ул. Покровка", 12, "Apartment", (55.76, 37.65)),
    # САО
    ("Москва", "Ленинградский проспект", 30, "Apartment", (55.79, 37.54)),
    ("Москва", "ул. 1-я Ямская", 8, "Apartment", (55.78, 37.58)),
    ("Москва", "Дмитровское шоссе", 40, "Apartment", (55.82, 37.59)),
    # СВАО
    ("Москва", "проспект Мира", 50, "Apartment", (55.79, 37.63)),
    ("Москва", "Ярославское шоссе", 60, "Apartment", (55.84, 37.66)),
    # ВАО
    ("Москва", "ул. Сокольнический вал", 25, "Apartment", (55.78, 37.69)),
    ("Москва", "Измайловский проспект", 35, "Apartment", (55.79, 37.78)),
    # ЮВАО
    ("Москва", "Волгоградский проспект", 45, "Apartment", (55.73, 37.73)),
    ("Москва", "ул. Люблинская", 30, "Apartment", (55.69, 37.73)),
    # ЮАО
    ("Москва", "Варшавское шоссе", 55, "Apartment", (55.68, 37.61)),
    ("Москва", "Каширское шоссе", 48, "Apartment", (55.66, 37.63)),
    # ЮЗАО
    ("Москва", "Ленинский проспект", 42, "Apartment", (55.70, 37.58)),
    ("Москва", "ул. Профсоюзная", 38, "Apartment", (55.69, 37.56)),
    # ЗАО
    ("Москва", "Кутузовский проспект", 18, "Apartment", (55.74, 37.52)),
    ("Москва", "ул. Арбат", 7, "Apartment", (55.75, 37.60)),
    # СЗАО
    ("Москва", "ул. Народного Ополчения", 28, "Apartment", (55.77, 37.47)),
    ("Москва", "Хорошёвское шоссе", 35, "Apartment", (55.78, 37.50)),
    # НАО (Новая Москва)
    ("Москва", "Коммунарка", 4, "House", (55.58, 37.48)),
    ("Москва", "Троицк", 3, "House", (55.49, 37.18)),
]

TULA_ADDRESSES = [
    ("Тула", "пр. Ленина", 25, "Apartment", (54.20, 37.62)),
    ("Тула", "ул. Пролетарская", 18, "Apartment", (54.21, 37.60)),
    ("Тула", "ул. Октябрьская", 15, "Apartment", (54.19, 37.64)),
    ("Тула", "ул. Красноармейский проспект", 12, "Apartment", (54.22, 37.61)),
    ("Тула", "ул. Советская", 22, "Apartment", (54.20, 37.63)),
    ("Тула", "пос. Плановский", 6, "House", (54.18, 37.58)),
]

TULA_REGION_ADDRESSES = [
    ("Новомосковск", "ул. Комсомольская", 16, "Apartment", (54.05, 38.27)),
    ("Донской", "ул. Ленина", 12, "Apartment", (53.98, 38.33)),
    ("Алексин", "ул. Советская", 10, "Apartment", (54.50, 37.07)),
    ("Щёкино", "ул. Ленина", 14, "Apartment", (53.62, 37.51)),
    ("Ефремов", "ул. Ленина", 13, "Apartment", (53.15, 38.10)),
]
...
async def get_coordinates(geocoder, city, street, house):
    """Получить координаты через геокодер или использовать дефолтные"""
    ...
    # Если геокодер не сработал, используем дефолтные координаты для города
    city_coords = {
        "Москва": (55.75, 37.61),
        "Тула": (54.20, 37.62),
        "Новомосковск": (54.05, 38.27),
        "Донской": (53.98, 38.33),
        "Алексин": (54.50, 37.07),
        "Щёкино": (53.62, 37.51),
        "Ефремов": (53.15, 38.10),
    ...
    return city_coords.get(city, (55.75, 37.61))
...
async def populate():
    async with AsyncSession(engine) as session:
        ...
        for i, addr in enumerate(selected_addresses):
            city, street, house, prop_type, default_coords = addr
