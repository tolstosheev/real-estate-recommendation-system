  ...
  return (
    <div
      className={cn('property-card', {
        ...
        'property-card--no-hover': likeBtnHovered,
      })}
      onClick={handleClick}
    >
      <div className="property-card__image-wrapper">
        ...
        {property.is_ai_recommendation && (
          <span className={cn('property-card__ai-badge', {
            'property-card__ai-badge--center': showActions,
            'property-card__ai-badge--right': !showActions,
          })}>AI</span>
        )}
        ...
        {showActions && (
           <button
             ...
             onClick={handleLike}
             onMouseEnter={() => setLikeBtnHovered(true)}
             onMouseLeave={() => setLikeBtnHovered(false)}
           >
